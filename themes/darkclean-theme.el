...
(custom-theme-set-faces
 ...
 '(whitespace-space ((t (:background "#0a0a0a" :foreground "#111"))))
 '(whitespace-hspace ((t (:background "#444" :foreground "#888"))))
 ...
 '(whitespace-big-indent ((t (:background "#400" :foreground "#800"))))
 '(whitespace-empty ((t (:background "#440" :foreground "#800"))))
 '(whitespace-line ((t (:background "#101"))))
